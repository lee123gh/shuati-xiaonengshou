...
const ids = fs.readFileSync(path.join(dir, '_smoke_scan_results_v2.txt'), 'utf8').split('\n')
...
fs.writeFileSync(path.join(dir, '_embedded_detail_v2.txt'), lines.join('\n'), 'utf8');
console.log('已输出 ' + ids.length + ' 条明细到 _embedded_detail_v2.txt');
